...
.method public addLenient(Lcom/squareup/okhttp/Headers$Builder;Ljava/lang/String;)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lcom/squareup/okhttp/Headers$Builder;->b(Ljava/lang/String;)Lcom/squareup/okhttp/Headers$Builder;
...
.method public addLenient(Lcom/squareup/okhttp/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2
    invoke-virtual {p1, p2, p3}, Lcom/squareup/okhttp/Headers$Builder;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/squareup/okhttp/Headers$Builder;
...
.method public apply(Lcom/squareup/okhttp/ConnectionSpec;Ljavax/net/ssl/SSLSocket;Z)V
    ...
    .line 1
    invoke-virtual {p1, p2, p3}, Lcom/squareup/okhttp/ConnectionSpec;->e(Ljavax/net/ssl/SSLSocket;Z)V
...
.method public callEnqueue(Lcom/squareup/okhttp/Call;Lcom/squareup/okhttp/Callback;Z)V
    ...
    .line 1
    invoke-virtual {p1, p2, p3}, Lcom/squareup/okhttp/Call;->d(Lcom/squareup/okhttp/Callback;Z)V
...
.method public connectionBecameIdle(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/internal/io/RealConnection;)Z
    ...
    .line 1
    invoke-virtual {p1, p2}, Lcom/squareup/okhttp/ConnectionPool;->b(Lcom/squareup/okhttp/internal/io/RealConnection;)Z
...
.method public get(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/Address;Lcom/squareup/okhttp/internal/http/StreamAllocation;)Lcom/squareup/okhttp/internal/io/RealConnection;
    ...
    .line 1
    invoke-virtual {p1, p2, p3}, Lcom/squareup/okhttp/ConnectionPool;->c(Lcom/squareup/okhttp/Address;Lcom/squareup/okhttp/internal/http/StreamAllocation;)Lcom/squareup/okhttp/internal/io/RealConnection;
...
.method public getHttpUrlChecked(Ljava/lang/String;)Lcom/squareup/okhttp/HttpUrl;
    ...
    .line 1
    invoke-static {p1}, Lcom/squareup/okhttp/HttpUrl;->j(Ljava/lang/String;)Lcom/squareup/okhttp/HttpUrl;
...
.method public internalCache(Lcom/squareup/okhttp/OkHttpClient;)Lcom/squareup/okhttp/internal/InternalCache;
    ...
    .line 1
    invoke-virtual {p1}, Lcom/squareup/okhttp/OkHttpClient;->c()Lcom/squareup/okhttp/internal/InternalCache;
...
.method public put(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/internal/io/RealConnection;)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lcom/squareup/okhttp/ConnectionPool;->e(Lcom/squareup/okhttp/internal/io/RealConnection;)V
...
.method public setCache(Lcom/squareup/okhttp/OkHttpClient;Lcom/squareup/okhttp/internal/InternalCache;)V
    ...
    .line 1
    invoke-virtual {p1, p2}, Lcom/squareup/okhttp/OkHttpClient;->d(Lcom/squareup/okhttp/internal/InternalCache;)V
