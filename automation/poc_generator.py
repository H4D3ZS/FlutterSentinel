...
"""
        ...
        poc = PoC(
            ...
            description=f"The application's deep link handler does not properly sanitize the 'param' parameter, allowing {vuln_type} attacks.",
            ...
            poc_type="python",
            remediation="Sanitize and validate all deep link parameters before processing. Implement input validation and output encoding.",
...
"""
        ...
        poc = PoC(
            ...
            description=f"The API endpoint {endpoint} does not properly validate user authorization, allowing access to other users' data.",
            impact="An attacker can access, modify, or delete other users' sensitive information by manipulating the user ID parameter.",
            steps_to_reproduce=[
