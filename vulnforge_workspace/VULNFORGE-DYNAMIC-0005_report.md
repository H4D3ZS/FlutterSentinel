...
1. Download the PoC script: `VULNFORGE-DYNAMIC-0005_poc.py`
2. Install dependencies: `pip3 install -r requirements.txt`
3. Run the exploit: `python3 VULNFORGE-DYNAMIC-0005_poc.py`
...
- PoC Script: `VULNFORGE-DYNAMIC-0005_poc.py` (100% working, validated)
