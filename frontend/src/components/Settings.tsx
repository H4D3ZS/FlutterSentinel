    ...
    useEffect(() => {
        api.getSettings()
            .then((data: any) => {
                ...
                // Handle hash routing after loading
                setTimeout(() => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700 pb-20">
            ...
            <form onSubmit={handleSave} className="space-y-8">
                ...
                {/* Intelligence Keys */}
                <Card id="keys" className="glass-surface border-slate-800 sovereign-glow scroll-mt-24">
                    <CardHeader>
                ...
                {/* Notifications */}
                <Card id="preferences" className="glass-surface border-slate-800 sovereign-glow scroll-mt-24">
                    <CardHeader>
                        <CardTitle className="text-lg font-bold flex items-center gap-2">
