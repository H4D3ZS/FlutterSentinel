...
.method public static synthetic a(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Landroid/net/Uri;)V
    ...
    .line 1
    iget-object p0, p0, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->b:Ljava/util/Map;
...
# virtual methods
.method public final b(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    .locals 7
...
.method public connect(Landroid/net/Uri;Ljava/util/Set;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 10
    .line 11
    invoke-virtual {v0}, Ley1;->c()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 19
    invoke-virtual {p0, v0, p1, p2, v1}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    ...
    .line 31
    .line 32
    invoke-static {p1}, Lo64;->a(Ljava/lang/Throwable;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 40
    .line 41
    invoke-direct {v1, p0, p1}, Lkw9;-><init>(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Landroid/net/Uri;)V

    .line 42
    .line 43
    .line 44
    invoke-direct {v0, v1}, Ley1;-><init>(Ljava/lang/Runnable;)V
    ...
    .line 55
    .line 56
    invoke-direct {p1, v1, p2, v0}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Ley1;)V
...
.method public serviceExistsForScope(Landroid/net/Uri;Ljava/util/Set;)Z
    ...
    .line 14
    invoke-virtual {p0, v0, p1, p2, v2}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
