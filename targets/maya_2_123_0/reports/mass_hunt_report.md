# Maya 2 123 0 - Security Vulnerability Report

## 🛠️ Target Information
- **Program**: Maya_2_123_0
- **Package ID**: `None`
- **Platform**: IPA
...
**Location**: `Payload/PayMaya.app/PlugIns/PayMaya-NotificationService.appex/Info.plist`
...
### 🟡 3. Sensitive File Found: .sqlite

**Severity**: MEDIUM
**Category**: SENSITIVE_FILES
**Location**: `Payload/PayMaya.app/PayMaya-Persistent-v2.sqlite`

#### Summary & Description
Found a file with extension .sqlite (Database file): PayMaya-Persistent-v2.sqlite
...
**Severity**: MEDIUM
**Category**: IOS_BINARY
**Location**: `Payload/PayMaya.app/PayMaya`
...
### 🟡 12. Insecure Mach-O Symbol: system
