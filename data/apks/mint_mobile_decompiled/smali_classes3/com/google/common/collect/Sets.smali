...
.method public static c(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
    .locals 0
...
.method public static cartesianProduct(Ljava/util/List;)Ljava/util/Set;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/common/collect/Sets$f;->d(Ljava/util/List;)Ljava/util/Set;
...
.method public static combinations(Ljava/util/Set;I)Ljava/util/Set;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/common/collect/Maps;->u(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableMap;
...
.method public static complementOf(Ljava/util/Collection;)Ljava/util/EnumSet;
    ...
    .line 6
    invoke-static {p0, v0}, Lcom/google/common/collect/Sets;->c(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
...
.method public static complementOf(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
    ...
    .line 10
    :cond_0
    invoke-static {p0, p1}, Lcom/google/common/collect/Sets;->c(Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/EnumSet;
...
.method public static varargs immutableEnumSet(Ljava/lang/Enum;[Ljava/lang/Enum;)Lcom/google/common/collect/ImmutableSet;
    ...
    invoke-static {p0}, Lbg4;->m(Ljava/util/EnumSet;)Lcom/google/common/collect/ImmutableSet;
...
.method public static synchronizedNavigableSet(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/common/collect/l0;->q(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;
...
.method public static toImmutableEnumSet()Ljava/util/stream/Collector;
    ...
    .line 1
    invoke-static {}, Lcom/google/common/collect/l;->J()Ljava/util/stream/Collector;
