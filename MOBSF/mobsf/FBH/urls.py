...
urlpatterns = [
    ...
    # Remove legacy page routes - handled by React Router
    ...
    path('fbh/api/targets/<str:target_name>/', views.api_target_detail, name='fbh_api_target_detail'),
    ...
    re_path(r'^fbh/?$', views.index, name='fbh_index'),
    re_path(r'^fbh/.*$', views.index, name='fbh_spa_catchall'),
]
