...
.field public final s:Landroidx/camera/camera2/internal/compat/workaround/ForceCloseDeferrableSurface;
...
.field public final v:Landroidx/camera/camera2/internal/compat/workaround/SessionResetPolicy;

.field public final w:Ljava/util/concurrent/atomic/AtomicBoolean;


# direct methods
.method public constructor <init>(Landroidx/camera/core/impl/Quirks;Landroidx/camera/core/impl/Quirks;Landroidx/camera/camera2/internal/i;Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Landroid/os/Handler;)V
    .locals 0

    .line 1
    invoke-direct {p0, p3, p4, p5, p6}, Landroidx/camera/camera2/internal/o;-><init>(Landroidx/camera/camera2/internal/i;Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Landroid/os/Handler;)V
    ...
    .line 8
    .line 9
    iput-object p3, p0, Lth9;->p:Ljava/lang/Object;
    ...
    .line 16
    .line 17
    iput-object p3, p0, Lth9;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 23
    .line 24
    iput-object p3, p0, Lth9;->s:Landroidx/camera/camera2/internal/compat/workaround/ForceCloseDeferrableSurface;
    ...
    .line 47
    .line 48
    iput-object p3, p0, Lth9;->u:Landroidx/camera/camera2/internal/compat/workaround/RequestMonitor;
    ...
    .line 54
    .line 55
    iput-object p1, p0, Lth9;->t:Landroidx/camera/camera2/internal/compat/workaround/ForceCloseCaptureSession;
    ...
    .line 61
    .line 62
    iput-object p1, p0, Lth9;->v:Landroidx/camera/camera2/internal/compat/workaround/SessionResetPolicy;

    .line 63
    .line 64
    iput-object p5, p0, Lth9;->o:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static synthetic p(Lth9;Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    .locals 0

    .line 1
    invoke-super {p0, p1}, Landroidx/camera/camera2/internal/o;->c(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
...
.method public static synthetic q(Lth9;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 0

    .line 1
    iget-object p4, p0, Lth9;->v:Landroidx/camera/camera2/internal/compat/workaround/SessionResetPolicy;
    ...
    .line 13
    .line 14
    invoke-virtual {p0, p4}, Lth9;->t(Ljava/lang/String;)V

    .line 15
    .line 16
    .line 17
    invoke-super {p0, p1, p2, p3}, Landroidx/camera/camera2/internal/o;->openCaptureSession(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static synthetic r(Lth9;)V
    .locals 1
    ...
    .line 2
    .line 3
    invoke-virtual {p0, v0}, Lth9;->t(Ljava/lang/String;)V

    .line 4
    .line 5
    .line 6
    invoke-super {p0}, Landroidx/camera/camera2/internal/o;->close()V
...
.method public c(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, Lth9;->t:Landroidx/camera/camera2/internal/compat/workaround/ForceCloseCaptureSession;
    ...
    .line 9
    .line 10
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/i;->e()Ljava/util/List;
    ...
    .line 14
    iget-object v2, p0, Landroidx/camera/camera2/internal/o;->b:Landroidx/camera/camera2/internal/i;

    .line 15
    .line 16
    invoke-virtual {v2}, Landroidx/camera/camera2/internal/i;->d()Ljava/util/List;
    ...
    .line 21
    .line 22
    invoke-direct {v3, p0}, Lqh9;-><init>(Lth9;)V
...
.method public captureBurstRequests(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
    ...
    .line 1
    iget-object v0, p0, Lth9;->u:Landroidx/camera/camera2/internal/compat/workaround/RequestMonitor;
    ...
    .line 7
    invoke-super {p0, p1, p2}, Landroidx/camera/camera2/internal/o;->captureBurstRequests(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Lth9;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 17
    :cond_0
    iget-object v0, p0, Lth9;->v:Landroidx/camera/camera2/internal/compat/workaround/SessionResetPolicy;
    ...
    .line 29
    .line 30
    invoke-virtual {p0}, Landroidx/camera/camera2/internal/o;->abortCaptures()V
    :try_end_0
    ...
    .line 67
    .line 68
    invoke-direct {v1, p0}, Lrh9;-><init>(Lth9;)V
...
.method public finishClose()V
    ...
    .line 1
    invoke-super {p0}, Landroidx/camera/camera2/internal/o;->finishClose()V
...
.method public getOpeningBlocker()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    iget-object v0, p0, Lth9;->o:Ljava/util/concurrent/ScheduledExecutorService;

    .line 2
    .line 3
    iget-object v1, p0, Lth9;->u:Landroidx/camera/camera2/internal/compat/workaround/RequestMonitor;
...
.method public onCameraDeviceError(I)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroidx/camera/camera2/internal/o;->onCameraDeviceError(I)V
    ...
    .line 6
    .line 7
    iget-object p1, p0, Lth9;->p:Ljava/lang/Object;
    ...
    .line 15
    .line 16
    iget-object v0, p0, Lth9;->q:Ljava/util/List;
...
.method public onClosed(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    .line 1
    iget-object v0, p0, Lth9;->p:Ljava/lang/Object;
    ...
    .line 4
    :try_start_0
    iget-object v1, p0, Lth9;->s:Landroidx/camera/camera2/internal/compat/workaround/ForceCloseDeferrableSurface;

    .line 5
    .line 6
    iget-object v2, p0, Lth9;->q:Ljava/util/List;
    ...
    .line 16
    .line 17
    invoke-super {p0, p1}, Landroidx/camera/camera2/internal/o;->onClosed(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
...
.method public openCaptureSession(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 5
    .line 6
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/i;->d()Ljava/util/List;
    ...
    .line 45
    iput-object v1, p0, Lth9;->r:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 52
    .line 53
    invoke-direct {v2, p0, p1, p2, p3}, Lsh9;-><init>(Lth9;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)V
...
.method public final s()V
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/i;->d()Ljava/util/List;
...
.method public setSingleRepeatingRequest(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
    ...
    .line 7
    invoke-super {p0, p1, p2}, Landroidx/camera/camera2/internal/o;->setSingleRepeatingRequest(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
...
.method public startWithDeferrableSurface(Ljava/util/List;J)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 4
    :try_start_0
    iput-object p1, p0, Lth9;->q:Ljava/util/List;

    .line 5
    .line 6
    invoke-super {p0, p1, p2, p3}, Landroidx/camera/camera2/internal/o;->startWithDeferrableSurface(Ljava/util/List;J)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public stop()Z
    ...
    .line 20
    :cond_0
    iget-object v1, p0, Lth9;->r:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    :cond_1
    :goto_0
    invoke-super {p0}, Landroidx/camera/camera2/internal/o;->stop()Z
