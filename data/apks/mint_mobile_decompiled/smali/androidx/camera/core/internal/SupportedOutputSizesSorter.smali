...
.method public constructor <init>(Landroidx/camera/core/impl/CameraInfoInternal;Landroid/util/Size;)V
    ...
    .line 32
    .line 33
    invoke-direct {v0, p1, p2}, Lxf9;-><init>(Landroidx/camera/core/impl/CameraInfoInternal;Landroid/util/Rational;)V

    .line 34
    .line 35
    .line 36
    iput-object v0, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->e:Lxf9;
...
.method public static a(Ljava/util/List;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    .locals 0

    .line 1
    invoke-static {p0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->n(Ljava/util/List;)Ljava/util/Map;
...
.method public static b(Ljava/util/Map;Landroidx/camera/core/resolutionselector/AspectRatioStrategy;Landroid/util/Rational;)Ljava/util/LinkedHashMap;
    .locals 4
    ...
    .line 20
    invoke-static {v1, v0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->m(IZ)Landroid/util/Rational;
    ...
    .line 34
    invoke-static {p1, v0}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->m(IZ)Landroid/util/Rational;
...
.method public static e(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionFilter;III)Ljava/util/List;
    .locals 1
...
.method public static g(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionStrategy;)V
    ...
    .line 41
    :cond_2
    invoke-static {p0, p1, v3}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->p(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 45
    :cond_3
    invoke-static {p0, p1, v1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->p(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 49
    :cond_4
    invoke-static {p0, p1, v3}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->o(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 53
    :cond_5
    invoke-static {p0, p1, v1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->o(Ljava/util/List;Landroid/util/Size;Z)V
    ...
    .line 57
    :cond_6
    invoke-static {p0, p1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->q(Ljava/util/List;Landroid/util/Size;)V
...
.method public static q(Ljava/util/List;Landroid/util/Size;)V
    .locals 1
...
.method public getSortedSupportedOutputSizes(Landroidx/camera/core/impl/UseCaseConfig;)Ljava/util/List;
    ...
    .line 24
    invoke-virtual {p0, v3, v4}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->j(Ljava/util/List;I)Ljava/util/List;
    ...
    .line 29
    .line 30
    iget-object v0, p0, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->e:Lxf9;

    .line 31
    .line 32
    invoke-virtual {v0, v3, p1}, Lxf9;->f(Ljava/util/List;Landroidx/camera/core/impl/UseCaseConfig;)Ljava/util/List;
    ...
    .line 59
    invoke-virtual {p0, v3, v2, p1}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->c(Ljava/util/List;Landroidx/camera/core/resolutionselector/ResolutionSelector;I)Ljava/util/List;
...
.method public final j(Ljava/util/List;I)Ljava/util/List;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/camera/core/internal/SupportedOutputSizesSorter;->l(Ljava/util/List;I)Ljava/util/List;
