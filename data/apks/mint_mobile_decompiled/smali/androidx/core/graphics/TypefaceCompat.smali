...
.method static constructor <clinit>()V
    ...
    .line 16
    .line 17
    sput-object v0, Landroidx/core/graphics/TypefaceCompat;->a:Le0a;
...
.method public static create(Landroid/content/Context;Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
    ...
    .line 5
    :cond_0
    sget-object v0, Landroidx/core/graphics/TypefaceCompat;->a:Le0a;

    invoke-virtual {v0, p0, p1, p2, p3}, Le0a;->c(Landroid/content/Context;Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
...
.method public static createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    .line 7
    .line 8
    invoke-virtual {v0, p0, p1, p2, p3}, Le0a;->createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
...
.method public static createFromFontInfoWithFallback(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    .line 7
    .line 8
    invoke-virtual {v0, p0, p1, p2, p3}, Le0a;->createFromFontInfoWithFallback(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
...
.method public static createFromResourcesFamilyXml(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FamilyResourceEntry;Landroid/content/res/Resources;ILjava/lang/String;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 4
    invoke-static {v2}, Landroidx/core/graphics/TypefaceCompat;->b(Ljava/lang/String;)Landroid/graphics/Typeface;
    ...
    .line 13
    invoke-static {v0, p1}, Lcc9;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 16
    :cond_6
    sget-object v2, Landroidx/core/graphics/TypefaceCompat;->a:Le0a;

    check-cast p1, Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;

    move/from16 v7, p6

    invoke-virtual {v2, p0, p1, p2, v7}, Le0a;->createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
...
.method public static createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Le0a;->createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
