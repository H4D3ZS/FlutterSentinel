...
export async function shodanSearch(query: string, apiKey?: string): Promise<any> {
    if (!apiKey) {
...
export async function googleDork(query: string, apiKey?: string, cx?: string): Promise<any> {
    if (!apiKey || !cx) {
