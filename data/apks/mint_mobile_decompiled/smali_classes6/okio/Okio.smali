...
.method public static final appendingSink(Ljava/io/File;)Lokio/Sink;
    ...
    .line 1
    invoke-static {p0}, Lf27;->a(Ljava/io/File;)Lokio/Sink;
...
.method public static final asResourceFileSystem(Ljava/lang/ClassLoader;)Lokio/FileSystem;
    ...
    .line 1
    invoke-static {p0}, Lf27;->b(Ljava/lang/ClassLoader;)Lokio/FileSystem;
...
.method public static final blackhole()Lokio/Sink;
    ...
    .line 1
    invoke-static {}, Lg27;->a()Lokio/Sink;
...
.method public static final buffer(Lokio/Sink;)Lokio/BufferedSink;
    ...
    .line 1
    invoke-static {p0}, Lg27;->b(Lokio/Sink;)Lokio/BufferedSink;
...
.method public static final buffer(Lokio/Source;)Lokio/BufferedSource;
    ...
    .line 2
    invoke-static {p0}, Lg27;->c(Lokio/Source;)Lokio/BufferedSource;
...
.method public static final cipherSink(Lokio/Sink;Ljavax/crypto/Cipher;)Lokio/CipherSink;
    ...
    .line 1
    invoke-static {p0, p1}, Lf27;->c(Lokio/Sink;Ljavax/crypto/Cipher;)Lokio/CipherSink;
...
.method public static final cipherSource(Lokio/Source;Ljavax/crypto/Cipher;)Lokio/CipherSource;
    ...
    .line 1
    invoke-static {p0, p1}, Lf27;->d(Lokio/Source;Ljavax/crypto/Cipher;)Lokio/CipherSource;
...
.method public static final hashingSink(Lokio/Sink;Ljava/security/MessageDigest;)Lokio/HashingSink;
    ...
    .line 1
    invoke-static {p0, p1}, Lf27;->e(Lokio/Sink;Ljava/security/MessageDigest;)Lokio/HashingSink;
...
.method public static final hashingSink(Lokio/Sink;Ljavax/crypto/Mac;)Lokio/HashingSink;
    ...
    .line 2
    invoke-static {p0, p1}, Lf27;->f(Lokio/Sink;Ljavax/crypto/Mac;)Lokio/HashingSink;
...
.method public static final hashingSource(Lokio/Source;Ljava/security/MessageDigest;)Lokio/HashingSource;
    ...
    .line 1
    invoke-static {p0, p1}, Lf27;->g(Lokio/Source;Ljava/security/MessageDigest;)Lokio/HashingSource;
...
.method public static final hashingSource(Lokio/Source;Ljavax/crypto/Mac;)Lokio/HashingSource;
    ...
    .line 2
    invoke-static {p0, p1}, Lf27;->h(Lokio/Source;Ljavax/crypto/Mac;)Lokio/HashingSource;
...
.method public static final inMemorySocketPair(J)[Lokio/Socket;
    ...
    .line 1
    invoke-static {p0, p1}, Lf27;->i(J)[Lokio/Socket;
...
.method public static final openZip(Lokio/FileSystem;Lokio/Path;)Lokio/FileSystem;
    ...
    .line 1
    invoke-static {p0, p1}, Lh27;->a(Lokio/FileSystem;Lokio/Path;)Lokio/FileSystem;
...
.method public static final sink(Ljava/io/File;)Lokio/Sink;
    ...
    .line 1
    invoke-static {p0}, Lf27;->j(Ljava/io/File;)Lokio/Sink;
...
.method public static final sink(Ljava/io/File;Z)Lokio/Sink;
    ...
    .line 2
    invoke-static {p0, p1}, Lf27;->k(Ljava/io/File;Z)Lokio/Sink;
...
.method public static final sink(Ljava/io/OutputStream;)Lokio/Sink;
    ...
    .line 3
    invoke-static {p0}, Lf27;->l(Ljava/io/OutputStream;)Lokio/Sink;
...
.method public static final sink(Ljava/net/Socket;)Lokio/Sink;
    ...
    .line 4
    invoke-static {p0}, Lf27;->m(Ljava/net/Socket;)Lokio/Sink;
...
.method public static final varargs sink(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Sink;
    ...
    .line 5
    invoke-static {p0, p1}, Lf27;->n(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Sink;
...
.method public static synthetic sink$default(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lf27;->o(Ljava/io/File;ZILjava/lang/Object;)Lokio/Sink;
...
.method public static final socket(Ljava/net/Socket;)Lokio/Socket;
    ...
    .line 1
    invoke-static {p0}, Lf27;->p(Ljava/net/Socket;)Lokio/Socket;
...
.method public static final source(Ljava/io/File;)Lokio/Source;
    ...
    .line 1
    invoke-static {p0}, Lf27;->q(Ljava/io/File;)Lokio/Source;
...
.method public static final source(Ljava/io/InputStream;)Lokio/Source;
    ...
    .line 2
    invoke-static {p0}, Lf27;->r(Ljava/io/InputStream;)Lokio/Source;
...
.method public static final source(Ljava/net/Socket;)Lokio/Source;
    ...
    .line 3
    invoke-static {p0}, Lf27;->s(Ljava/net/Socket;)Lokio/Source;
...
.method public static final varargs source(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Source;
    ...
    .line 4
    invoke-static {p0, p1}, Lf27;->t(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Source;
...
.method public static final use(Ljava/io/Closeable;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Lg27;->d(Ljava/io/Closeable;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;
