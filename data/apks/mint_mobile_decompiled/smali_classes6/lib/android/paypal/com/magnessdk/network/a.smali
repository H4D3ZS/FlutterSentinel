.class public Llib/android/paypal/com/magnessdk/network/a;
...
.method public constructor <init>(Llib/android/paypal/com/magnessdk/c$h$d;Llib/android/paypal/com/magnessdk/MagnesSettings;Landroid/os/Handler;Lorg/json/JSONObject;)V
    ...
    .param p1    # Llib/android/paypal/com/magnessdk/c$h$d;
        ...
        .end annotation
    .end param
    .param p2    # Llib/android/paypal/com/magnessdk/MagnesSettings;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Llib/android/paypal/com/magnessdk/network/a;->b:Llib/android/paypal/com/magnessdk/c$h$d;

    iput-object p2, p0, Llib/android/paypal/com/magnessdk/network/a;->f:Llib/android/paypal/com/magnessdk/MagnesSettings;

    iput-object p3, p0, Llib/android/paypal/com/magnessdk/network/a;->d:Landroid/os/Handler;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Llib/android/paypal/com/magnessdk/network/a;->c:Ljava/util/Map;
    ...
    :goto_0
    iput-object p1, p0, Llib/android/paypal/com/magnessdk/network/a;->e:Llib/android/paypal/com/magnessdk/network/base/MagnesNetworkingFactoryImpl;

    iput-object p4, p0, Llib/android/paypal/com/magnessdk/network/a;->g:Lorg/json/JSONObject;
...
.method public a()V
    ...
    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->b:Llib/android/paypal/com/magnessdk/c$h$d;

    sget-object v1, Llib/android/paypal/com/magnessdk/c$h$d;->d:Llib/android/paypal/com/magnessdk/c$h$d;

    if-ne v0, v1, :cond_0

    invoke-virtual {p0}, Llib/android/paypal/com/magnessdk/network/a;->i()V
...
.method public c()V
    ...
    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->f:Llib/android/paypal/com/magnessdk/MagnesSettings;
    ...
    invoke-virtual {p0}, Llib/android/paypal/com/magnessdk/network/a;->d()V
...
.method public d()V
    ...
    :try_start_0
    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->e:Llib/android/paypal/com/magnessdk/network/base/MagnesNetworkingFactoryImpl;

    sget-object v1, Llib/android/paypal/com/magnessdk/c$h$b;->c:Llib/android/paypal/com/magnessdk/c$h$b;

    invoke-virtual {v0, v1}, Llib/android/paypal/com/magnessdk/network/base/MagnesNetworkingFactoryImpl;->createHttpClient(Llib/android/paypal/com/magnessdk/c$h$b;)Llib/android/paypal/com/magnessdk/network/base/MagnesNetworking;

    move-result-object v0

    invoke-virtual {p0}, Llib/android/paypal/com/magnessdk/network/a;->h()Ljava/lang/String;
    ...
    invoke-interface {v0, v2}, Llib/android/paypal/com/magnessdk/network/base/MagnesNetworking;->setUri(Landroid/net/Uri;)V

    iget-object v2, p0, Llib/android/paypal/com/magnessdk/network/a;->c:Ljava/util/Map;
    ...
    invoke-interface {v0, v2}, Llib/android/paypal/com/magnessdk/network/base/MagnesNetworking;->setHeader(Ljava/util/Map;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Llib/android/paypal/com/magnessdk/network/a;->d:Landroid/os/Handler;
    ...
    invoke-interface {v0, v1}, Llib/android/paypal/com/magnessdk/network/base/MagnesNetworking;->execute([B)I

    move-result v1

    new-instance v2, Ljava/lang/String;

    invoke-interface {v0}, Llib/android/paypal/com/magnessdk/network/base/MagnesNetworking;->getResponseContent()[B
    ...
    invoke-virtual {p0, v1, v2}, Llib/android/paypal/com/magnessdk/network/a;->e(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Llib/android/paypal/com/magnessdk/network/a;->f(Ljava/lang/String;)V

    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->d:Landroid/os/Handler;
    ...
    :goto_2
    iget-object v1, p0, Llib/android/paypal/com/magnessdk/network/a;->d:Landroid/os/Handler;
...
.method public final e(ILjava/lang/String;)V
    ...
    iget-object v2, p0, Llib/android/paypal/com/magnessdk/network/a;->b:Llib/android/paypal/com/magnessdk/c$h$d;
...
.method public final f(Ljava/lang/String;)V
    ...
    .line 1
    sget-object v0, Llib/android/paypal/com/magnessdk/network/a$a;->a:[I

    iget-object v1, p0, Llib/android/paypal/com/magnessdk/network/a;->b:Llib/android/paypal/com/magnessdk/c$h$d;
    ...
    iget-object p1, p0, Llib/android/paypal/com/magnessdk/network/a;->f:Llib/android/paypal/com/magnessdk/MagnesSettings;
...
.method public final g()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->g:Lorg/json/JSONObject;
    ...
    iget-object v1, p0, Llib/android/paypal/com/magnessdk/network/a;->g:Lorg/json/JSONObject;
    ...
    iget-object v1, p0, Llib/android/paypal/com/magnessdk/network/a;->f:Llib/android/paypal/com/magnessdk/MagnesSettings;
...
.method public final h()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0}, Llib/android/paypal/com/magnessdk/network/a;->g()Ljava/lang/String;
...
.method public final i()V
    ...
    :cond_0
    iget-object v1, p0, Llib/android/paypal/com/magnessdk/network/a;->c:Ljava/util/Map;
    ...
    iget-object v2, p0, Llib/android/paypal/com/magnessdk/network/a;->g:Lorg/json/JSONObject;
    ...
    iget-object v3, p0, Llib/android/paypal/com/magnessdk/network/a;->g:Lorg/json/JSONObject;
    ...
    iget-object v0, p0, Llib/android/paypal/com/magnessdk/network/a;->c:Ljava/util/Map;
