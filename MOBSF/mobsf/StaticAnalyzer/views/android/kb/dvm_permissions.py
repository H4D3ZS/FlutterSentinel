...
DVM_PERMISSIONS = {
    'MANIFEST_PERMISSION': {
        ...
        'SEND_SMS_NO_CONFIRMATION': ['dangerous',
            'send SMS messages',
        ...
        'SET_TIME_ZONE': ['signatureOrSystem',
            'set time zone',
        ...
        'CLEAR_APP_CACHE': ['signatureOrSystem',
        ...
        'GLOBAL_SEARCH_CONTROL': ['signature',
            'permission without a specified role or function.',
            'Permission without a specified role or function.'],
            
        'SET_WALLPAPER_COMPONENT': ['signatureOrSystem',
            'allows setting of wallpaper components.',
            'Allows setting of wallpaper components.'],
        ...
        'C2D_MESSAGE': ['signature',
            'Allows cloud to device messaging',
            'Allows the application to receive push notifications.'],
            
        'ADD_VOICEMAIL': ['dangerous',
            'add voicemails into the system',
            'Allows an application to add voicemails into the system.'],
            
        'ACCEPT_HANDOVER': ['dangerous',
            'enables a calling app to continue a call started in another app.',
        ...
        'ACCESS_NOTIFICATION_POLICY': ['normal',
            'marker permission for accessing notification policy.',
            'Marker permission for applications that wish to access notification policy.'],
            
        'ANSWER_PHONE_CALLS': ['dangerous',
            'permits an app to answer incoming phone calls.',
        ...
        'BIND_CARRIER_SERVICES': ['signature',
            'system-level permission for binding to carrier services.',
        ...
        'BIND_VISUAL_VOICEMAIL_SERVICE': ['signature',
            'required by VisualVoicemailServices for system binding.',
        ...
        'CAPTURE_SECURE_VIDEO_OUTPUT': ['normal',
            'permits capturing of secure video output.',
            'Allows an application to capture secure video output.'],
            
        'CAPTURE_VIDEO_OUTPUT': ['normal',
            'allows capturing of video output.',
            'Allows an application to capture video output.'],
            
        'FOREGROUND_SERVICE': ['normal',
            'enables regular apps to use Service.startForeground.',
            'Allows a regular application to use Service.startForeground.'],
            
        'GET_ACCOUNTS_PRIVILEGED': ['signatureOrSystem',
            'grants access to the Accounts Service.',
            'Allows access to the list of accounts in the Accounts Service.'],
            
        'INSTALL_SHORTCUT': ['normal',
            'permits installation of shortcuts in Launcher.',
            'Allows an application to install a shortcut in Launcher.'],
            
        'INSTANT_APP_FOREGROUND_SERVICE': ['signatureOrSystem',
            'allows instant apps to create foreground services.',
        ...
        'MEDIA_CONTENT_CONTROL': ['normal',
            'allows control over media content playback.',
            'Allows an application to know what content is playing and control its playback.'],
            
        'NFC_TRANSACTION_EVENT': ['normal',
            'enables receiving NFC transaction events.',
            'Allows applications to receive NFC transaction events.'],
            
        'READ_CALL_LOG': ['dangerous',
            "grants read access to the user's call log.",
        ...
        'READ_VOICEMAIL': ['signature',
            'permits an app to read voicemails in the system.',
        ...
        'REQUEST_COMPANION_USE_DATA_IN_BACKGROUND': ['normal',
            'permits a companion app to use data in the background.',
            'Allows a companion app to use data in the background.'],
            
        'REQUEST_DELETE_PACKAGES': ['normal',
            'enables an app to request package deletions.',
            'Allows an application to request deleting packages.'],
            
        'REQUEST_IGNORE_BATTERY_OPTIMIZATIONS': ['normal',
            'permission for using Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS.',
        ...
        'USE_BIOMETRIC': ['normal',
            'allows use of device-supported biometric modalities.',
            'Allows an app to use device supported biometric modalities.'],
            
        'USE_FINGERPRINT': ['normal',
            'allow use of fingerprint',
        ...
        'WRITE_VOICEMAIL': ['signature',
            'enables modification and removal of voicemails.',
        ...
        'ACCESS_MEDIA_LOCATION': ['dangerous',
            'access any geographic locations',
            "Allows an application to access any geographic locations persisted in the user's shared collection."],
            
        'ACTIVITY_RECOGNITION': ['dangerous',
            'allow application to recognize physical activity',
        ...
        'CALL_COMPANION_APP': ['normal',
            'enables an InCallService app to function as a calling companion.',
        ...
        'REQUEST_PASSWORD_COMPLEXITY': ['normal',
            'allows requesting and prompting for screen lock complexity upgrades.',
        ...
        'START_VIEW_PERMISSION_USAGE': ['signature',
            'allows starting the permission usage screen for an app.',
            'Allows the holder to start the permission usage screen for an app.'],
            
        'USE_FULL_SCREEN_INTENT': ['normal',
            'required for full screen intents in notifications.',
        ...
        'BIND_QUICK_ACCESS_WALLET_SERVICE': ['signature',
            'required by QuickAccessWalletServices for system binding.',
            'Must be required by a QuickAccessWalletService to ensure that only the system can bind to it.'],
            
        'INTERACT_ACROSS_PROFILES': ['normal',
            'enables interaction across profiles in the same group.',
            'Allows interaction across profiles in the same profile group.'],
            
        'LOADER_USAGE_STATS': ['signatureOrSystem',
            'allows data loaders to read package access logs.',
        ...
        'NFC_PREFERRED_PAYMENT_INFO': ['normal',
            'allows receiving NFC preferred payment service info.',
        ...
        'REQUEST_OBSERVE_COMPANION_DEVICE_PRESENCE': ['normal',
            'allows subscribing to companion device presence status notifications.',
        ...
        'SCHEDULE_EXACT_ALARM': ['normal',
            'permits exact alarm scheduling for background work.',
            'Allows an app to use exact alarm scheduling APIs to perform timing sensitive background work.'],
            
        'USE_ICC_AUTH_WITH_DEVICE_IDENTIFIER': ['signature',
            'allows reading device identifiers and using ICC-based authentication.',
        ...
        'ACCESS_BLOBS_ACROSS_USERS': ['normal',
            'enables access to data blobs across users.',
            'Allows an application to access data blobs across users.'],
            
        'BIND_CREDENTIAL_PROVIDER_SERVICE': ['signature',
            'required by CredentialProviderServices for system binding.',
            'Must be required by a CredentialProviderService to ensure that only the system can bind to it.'],
            
        'BIND_TV_INTERACTIVE_APP': ['signature',
            'required by TvInteractiveAppServices for system binding.',
            'Must be required by a TvInteractiveAppService to ensure that only the system can bind to it.'],
            
        'BLUETOOTH_ADVERTISE': ['dangerous',
            'required to advertise to nearby Bluetooth devices.',
            'Required to be able to advertise to nearby Bluetooth devices.'],
            
        'BLUETOOTH_CONNECT': ['dangerous',
            'necessary for connecting to paired Bluetooth devices.',
            'Required to be able to connect to paired Bluetooth devices.'],
            
        'BLUETOOTH_SCAN': ['dangerous',
            'required for discovering and pairing Bluetooth devices.',
        ...
        'CREDENTIAL_MANAGER_QUERY_CANDIDATE_CREDENTIALS': ['normal',
            'enables querying metadata of credential candidates.',
        ...
        'DELIVER_COMPANION_MESSAGES': ['normal',
            'allows delivery of companion messages to system.',
            'Allows an application to deliver companion messages to system'],
            
        'DETECT_SCREEN_CAPTURE': ['normal',
            "notifies when a screen capture of the app's windows is attempted.",
        ...
        'EXECUTE_APP_ACTION': ['internal',
            'allows assistive apps to perform actions inside other apps.',
            'Allows an assistive application to perform actions on behalf of users inside of applications.'],
            
        'FOREGROUND_SERVICE_CAMERA': ['normal',
            'allows foreground services with camera use.',
            'Allows a regular application to use Service.startForeground with the type "camera".'],
            
        'FOREGROUND_SERVICE_CONNECTED_DEVICE': ['normal',
            'enables foreground services with connected device use.',
        ...
        'FOREGROUND_SERVICE_DATA_SYNC': ['normal',
            'permits foreground services for data synchronization.',
            'Allows a regular application to use Service.startForeground with the type "dataSync".'],
            
        'FOREGROUND_SERVICE_HEALTH': ['normal',
            'enables foreground services with health-related functionality.',
            'Allows a regular application to use Service.startForeground with the type "health".'],
            
        'FOREGROUND_SERVICE_LOCATION': ['normal',
            'allows foreground services with location use.',
            'Allows a regular application to use Service.startForeground with the type "location".'],
            
        'FOREGROUND_SERVICE_MEDIA_PLAYBACK': ['normal',
            'enables foreground services for media playback.',
            'Allows a regular application to use Service.startForeground with the type "mediaPlayback".'],
            
        'FOREGROUND_SERVICE_MEDIA_PROJECTION': ['normal',
            'allows foreground services for media projection.',
            'Allows a regular application to use Service.startForeground with the type "mediaProjection".'],
            
        'FOREGROUND_SERVICE_MICROPHONE': ['normal',
            'permits foreground services with microphone use.',
            'Allows a regular application to use Service.startForeground with the type "microphone".'],
            
        'FOREGROUND_SERVICE_PHONE_CALL': ['normal',
            'enables foreground services during phone calls.',
            'Allows a regular application to use Service.startForeground with the type "phoneCall".'],
            
        'FOREGROUND_SERVICE_REMOTE_MESSAGING': ['normal',
            'allows foreground services for remote messaging.',
            'Allows a regular application to use Service.startForeground with the type "remoteMessaging".'],
            
        'FOREGROUND_SERVICE_SPECIAL_USE': ['normal',
            'enables special-use foreground services.',
            'Allows a regular application to use Service.startForeground with the type "specialUse".'],
            
        'FOREGROUND_SERVICE_SYSTEM_EXEMPTED': ['normal',
            'allows system-exempted types of foreground services.',
        ...
        'LAUNCH_CAPTURE_CONTENT_ACTIVITY_FOR_NOTE': ['internal',
            'enables screen content capture for screenshots.',
        ...
        'LAUNCH_MULTI_PANE_SETTINGS_DEEP_LINK': ['normal',
            'enables showing an Activity embedded in the Settings app.',
        ...
        'MANAGE_DEVICE_LOCK_STATE': ['internal',
            'allows financed device kiosk apps to interact with Device Lock service.',
            'Allows financed device kiosk apps to perform actions on the Device Lock service'],
            
        'MANAGE_DEVICE_POLICY_ACCESSIBILITY': ['normal',
            'enables managing policy related to accessibility.',
            'Allows an application to manage policy related to accessibility. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_ACCOUNT_MANAGEMENT': ['normal',
            'allows setting policy related to account management.',
            'Allows an application to set policy related to account management. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_ACROSS_USERS': ['normal',
            'enables setting secure device policies without user data access.',
            'Allows an application to set device policies outside the current user that are required for securing device ownership without accessing user data. Holding this permission allows the use of other held MANAGE_DEVICE_POLICY_* permissions across all users on the device provided they do not grant access to user data.'],
            
        'MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL': ['normal',
            'allows setting device policies with access to user data.',
            'Allows an application to set device policies outside the current user. Fuller form of MANAGE_DEVICE_POLICY_ACROSS_USERS that removes the restriction on accessing user data. Holding this permission allows the use of any other held MANAGE_DEVICE_POLICY_* permissions across all users on the device.  Constant Value:                "android.permission.MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL"'],
            
        'MANAGE_DEVICE_POLICY_ACROSS_USERS_SECURITY_CRITICAL': ['normal',
            'enables critical security policies for securing user data.',
            'Allows an application to set device policies outside the current user that are critical for securing data within the current user. Holding this permission allows the use of other held MANAGE_DEVICE_POLICY_* permissions across all users on the device provided they are required for securing data within the current user.'],
            
        'MANAGE_DEVICE_POLICY_AIRPLANE_MODE': ['normal',
            'permits setting policy related to airplane mode.',
            'Allows an application to set policy related to airplane mode. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_APPS_CONTROL': ['normal',
            'allows managing policy for modifying applications.',
            'Allows an application to manage policy regarding modifying applications. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_APP_RESTRICTIONS': ['normal',
            'enables management of application restrictions.',
            'Allows an application to manage application restrictions. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_APP_USER_DATA': ['normal',
            'allows setting policy for application user data.',
            'Allows an application to manage policy related to application user data. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_AUDIO_OUTPUT': ['normal',
            'enables policy setting for audio output.',
            'Allows an application to set policy related to audio output. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_AUTOFILL': ['normal',
            'allows setting policy for autofill services.',
            'Allows an application to set policy related to autofill. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_BACKUP_SERVICE': ['normal',
            'enables managing backup service policy.',
            'Allows an application to manage backup service policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_BLUETOOTH': ['normal',
            'permits setting policy related to Bluetooth.',
            'Allows an application to set policy related to bluetooth. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_BUGREPORT': ['normal',
            'allows requesting bugreports with user consent.',
            'Allows an application to request bugreports with user consent. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_CALLS': ['normal',
            'enables managing policy for phone calls.',
            'Allows an application to manage calling policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_CAMERA': ['normal',
            'permits policy setting for camera usage.',
            "Allows an application to set policy related to restricting a user's ability to use or enable and disable the camera. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user."],
            
        'MANAGE_DEVICE_POLICY_CERTIFICATES': ['normal',
            'allows policy management for certificates.',
            'Allows an application to set policy related to certificates. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_COMMON_CRITERIA_MODE': ['normal',
            'enables policy management for common criteria mode.',
            'Allows an application to manage policy related to common criteria mode. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_DEBUGGING_FEATURES': ['normal',
            'allows managing policy for debugging features.',
            'Allows an application to manage debugging features policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_DEFAULT_SMS': ['normal',
            'permits setting policy for the default SMS application.',
            'Allows an application to set policy related to the default sms application. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_DEVICE_IDENTIFIERS': ['normal',
            'enables policy management for device identifiers.',
            'Allows an application to manage policy related to device identifiers.'],
            
        'MANAGE_DEVICE_POLICY_DISPLAY': ['normal',
            'allows setting policy for display management.',
            'Allows an application to set policy related to the display. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_FACTORY_RESET': ['normal',
            'enables setting policy for factory resets.',
            'Allows an application to set policy related to factory reset. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_FUN': ['normal',
            'allows setting policy related to fun activities.',
            'Allows an application to set policy related to fun. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_INPUT_METHODS': ['normal',
            'permits policy setting for input methods.',
            'Allows an application to set policy related to input methods. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_INSTALL_UNKNOWN_SOURCES': ['normal',
            'enables policy for installing apps from unknown sources.',
            'Allows an application to manage installing from unknown sources policy. MANAGE_SECURITY_CRITICAL_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_KEEP_UNINSTALLED_PACKAGES': ['normal',
            'allows keeping uninstalled packages per policy.',
            'Allows an application to set policy related to keeping uninstalled packages. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_KEYGUARD': ['normal',
            'enables managing policy for keyguard settings.',
            'Allows an application to manage policy related to keyguard. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_SECURITY_CRITICAL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_LOCALE': ['normal',
            'allows setting policy for locale management.',
            'Allows an application to set policy related to locale. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_LOCATION': ['normal',
            'enables policy setting for location services.',
            'Allows an application to set policy related to location. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_LOCK': ['normal',
            'permits locking profiles or devices per policy.',
            'Allows an application to lock a profile or the device with the appropriate cross-user permission. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_LOCK_CREDENTIALS': ['normal',
            'enables policy setting for lock credentials.',
            'Allows an application to set policy related to lock credentials. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_SECURITY_CRITICAL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_LOCK_TASK': ['normal',
            'allows managing lock task policy.',
            'Allows an application to manage lock task policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_METERED_DATA': ['normal',
            'permits policy management for metered data.',
            'Allows an application to manage policy related to metered data. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_MICROPHONE': ['normal',
            'allows policy setting for microphone usage.',
            "Allows an application to set policy related to restricting a user's ability to use or enable and disable the microphone. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user."],
            
        'MANAGE_DEVICE_POLICY_MOBILE_NETWORK': ['normal',
            'enables setting policy for mobile networks.',
            'Allows an application to set policy related to mobile networks. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_MODIFY_USERS': ['normal',
            'allows policy management to prevent user modifications.',
            'Allows an application to manage policy preventing users from modifying users. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user'],
        ...
        'MANAGE_DEVICE_POLICY_NETWORK_LOGGING': ['normal',
            'enables setting policy for network logging.',
            'Allows an application to set policy related to network logging. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_ORGANIZATION_IDENTITY': ['normal',
            'allows managing the identity of the managing organization.',
            'Allows an application to manage the identity of the managing organization. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_OVERRIDE_APN': ['normal',
            'permits policy setting for overriding APNs.',
            'Allows an application to set policy related to override APNs. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_PACKAGE_STATE': ['normal',
            'enables policy for hiding and suspending packages.',
            'Allows an application to set policy related to hiding and suspending packages. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_PHYSICAL_MEDIA': ['normal',
            'allows setting policies for physical media usage.',
            'Allows an application to set policy related to physical media. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_PRINTING': ['normal',
            'allows setting policies for printing services.',
            'Allows an application to set policy related to printing. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_PRIVATE_DNS': ['normal',
            'allows setting policies for private DNS management.',
            'Allows an application to set policy related to private DNS. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_PROFILES': ['normal',
            'allows setting policies for user profiles.',
            'Allows an application to set policy related to profiles. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
        ...
        'MANAGE_DEVICE_POLICY_PROXY': ['normal',
            'allows setting a global HTTP proxy independently of network.',
            'Allows an application to set a network-independent global HTTP proxy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_QUERY_SYSTEM_UPDATES': ['normal',
            'allows querying system updates.',
            'Allows an application query system updates. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_RESET_PASSWORD': ['normal',
            'allows force setting a new device unlock password or profile challenge.',
            'Allows an application to force set a new device unlock password or a managed profile challenge on current user. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_RESTRICT_PRIVATE_DNS': ['normal',
            'allows restricting user configuration of private DNS.',
            'Allows an application to set policy related to restricting the user from configuring private DNS. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_RUNTIME_PERMISSIONS': ['normal',
            'allows setting runtime permissions for packages.',
            'Allows an application to set the grant state of runtime permissions on packages. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_RUN_IN_BACKGROUND': ['normal',
            'allows setting policies for background process management.',
            'Allows an application to set policy related to users running in the background. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SAFE_BOOT': ['normal',
            'allows managing policies for safe boot mode.',
            'Allows an application to manage safe boot policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SCREEN_CAPTURE': ['normal',
            'allows setting policies for screen capture functionality.',
            'Allows an application to set policy related to screen capture. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SCREEN_CONTENT': ['normal',
            'allows setting policies for the usage of screen contents.',
            'Allows an application to set policy related to the usage of the contents of the screen. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SECURITY_LOGGING': ['normal',
            'allows setting policies for security logging.',
            'Allows an application to set policy related to security logging. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SETTINGS': ['normal',
            'allows setting general device policies.',
            'Allows an application to set policy related to settings. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SMS': ['normal',
            'allows setting policies for SMS functionality.',
            'Allows an application to set policy related to sms. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_STATUS_BAR': ['normal',
            'allows setting policies for the status bar.',
            'Allows an application to set policy related to the status bar.'],
            
        'MANAGE_DEVICE_POLICY_SUPPORT_MESSAGE': ['normal',
            'allows setting support messages for policy-affected actions.',
            'Allows an application to set support messages for when a user action is affected by an active policy. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SUSPEND_PERSONAL_APPS': ['normal',
            'allows suspending personal apps through policy settings.',
            'Allows an application to set policy related to suspending personal apps. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SYSTEM_APPS': ['normal',
            'allows managing policies related to system apps.',
            'Allows an application to manage policy related to system apps. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SYSTEM_DIALOGS': ['normal',
            'allows setting policies for system dialogs.',
            'Allows an application to set policy related to system dialogs. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_SYSTEM_UPDATES': ['normal',
            'allows setting policies for system updates.',
            'Allows an application to set policy related to system updates. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_TIME': ['normal',
            'allows managing policies related to time settings.',
            'Allows an application to manage device policy relating to time. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_USB_DATA_SIGNALLING': ['normal',
            'allows setting policies for USB data signalling.',
            'Allows an application to set policy related to usb data signalling.'],
            
        'MANAGE_DEVICE_POLICY_USB_FILE_TRANSFER': ['normal',
            'allows setting policies for USB file transfers.',
            'Allows an application to set policy related to usb file transfers. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_USERS': ['normal',
            'allows setting policies related to user management.',
            'Allows an application to set policy related to users. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_VPN': ['normal',
            'allows setting policies for VPN usage.',
            'Allows an application to set policy related to VPNs. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_WALLPAPER': ['normal',
            'allows setting policies for wallpaper management.',
            'Allows an application to set policy related to the wallpaper. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_WIFI': ['normal',
            'allows setting policies for WiFi connectivity.',
            'Allows an application to set policy related to Wifi. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_WINDOWS': ['normal',
            'allows setting policies for window management.',
            'Allows an application to set policy related to windows. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS_FULL is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_DEVICE_POLICY_WIPE_DATA': ['normal',
            'allows managing policies for data wiping.',
            'Allows an application to manage policy related to wiping data. Manifest.permission#MANAGE_DEVICE_POLICY_ACROSS_USERS is required to call APIs protected by this permission on users different to the calling user.'],
            
        'MANAGE_MEDIA': ['signature',
            'allows modification and deletion of media files without user confirmation.',
        ...
        'PROVIDE_OWN_AUTOFILL_SUGGESTIONS': ['internal',
            'allows providing autofill suggestions using the autofill framework.',
            'Allows an application to display its suggestions using the autofill framework.'],
            
        'PROVIDE_REMOTE_CREDENTIALS': ['signature',
        ...
        'READ_ASSISTANT_APP_SEARCH_DATA': ['normal',
            'allows querying global AppSearch data visible to the Assistant role.',
        ...
        'READ_MEDIA_AUDIO': ['dangerous',
            'allows reading audio files from external storage.',
            'Allows an application to read audio files from external storage.'],
            
        'READ_MEDIA_IMAGES': ['dangerous',
            'allows reading image files from external storage.',
            'Allows an application to read image files from external storage.'],
            
        'READ_MEDIA_VIDEO': ['dangerous',
            'allows reading video files from external storage.',
        ...
        'REQUEST_COMPANION_PROFILE_GLASSES': ['normal',
            "allows requesting association with a device as 'glasses'.",
        ...
        'REQUEST_COMPANION_SELF_MANAGED': ['normal',
            'allows creating a self-managed companion device association.',
        ...
        'REQUEST_COMPANION_START_FOREGROUND_SERVICES_FROM_BACKGROUND': ['normal',
            'allows a companion app to start foreground services from the background.',
        ...
        'USE_EXACT_ALARM': ['normal',
            'allows using exact alarms without user permission.',
        ...
        'UWB_RANGING': ['dangerous',
            'required for ranging to devices using ultra-wideband.',
        ...
        'DETECT_SCREEN_RECORDING': ['normal',
            'Grants an application the ability to receive notifications when audio or screen recording is in progress.',
            'Allows an application to get notified when it is being recorded.'],
            
        'MANAGE_DEVICE_POLICY_BLOCK_UNINSTALL': ['internal',
            'Allows an application to control policies that prevent the uninstallation of specific packages.',
            'Allows an application to manage policy related to block package uninstallation.'],
            
        'MANAGE_DEVICE_POLICY_CAMERA_TOGGLE': ['internal',
            'Allows an application to enforce policies that control the state of the camera toggle.',
            'Allows an application to manage policy related to camera toggle.'],
            
        'MANAGE_DEVICE_POLICY_CONTENT_PROTECTION': ['internal',
            'Grants an application the ability to enforce policies that restrict the uninstallation of designated packages.',
            'Allows an application to manage policy related to content protection.'],
            
        'MANAGE_DEVICE_POLICY_MANAGED_SUBSCRIPTIONS': ['internal',
            'Grants an application the ability to configure policies for managing subscriptions downloaded by an administrator.',
            'Allows an application to set policy related to subscriptions downloaded by an admin.'],
            
        'MANAGE_DEVICE_POLICY_MICROPHONE_TOGGLE': ['internal',
            'Grants an application the ability to control policies for managing the microphone toggle state.',
        ...
        'ACCESS_ORIENTATION': ['normal',
            'Allows an application to access the device\'s orientation.',
            'Allows an application to access the device\'s orientation.'],
        ...
        'REQUEST_OBSERVE_DEVICE_UUID_PRESENCE': ['normal',
            'Observe nearby device presence by UUID',
            "Allows an application to subscribe to notifications about the nearby devices' presence status change base on the UUIDs. Not for use by third-party applications."],
    ...
    'SPECIAL_PERMISSIONS': {
        'com.sec.android.provider.badge.permission.READ': ['normal',
            'show notification count on app',
        ...
        'com.google.android.gms.permission.AD_ID': ['normal',
            'application shows advertisements',
            'This app uses a Google advertising ID and can possibly serve advertisements.'],
            
        'com.google.android.finsky.permission.BIND_GET_INSTALL_REFERRER_SERVICE': ['normal',
            'permission defined by google',
            'A custom permission defined by Google.'],
            
        'com.google.android.c2dm.permission.RECEIVE': ['normal',
            'recieve push notifications',
            'Allows an application to receive push notifications from cloud.'],
            
        'com.android.vending.BILLING': ['normal',
            'application has in-app purchases',
            'Allows an application to make in-app purchases from Google Play.'],
        ...
        'oppo.permission.OPPO_COMPONENT_SAFE': ['signature',
            ...
            'It is used to grant apps the ability to access certain system-level features or components that are otherwise restricted for security reasons. This permission ensures that only trusted applications can interact with sensitive parts of the OPPO system.'],
            
        'com.huawei.permission.external_app_settings.USE_COMPONENT': ['signature',
            'permission specific to Huawei devices',
            'It is used to grant apps the ability to access certain system-level features or components that are otherwise restricted for security reasons. This permission ensures that only trusted applications can interact with sensitive parts of the Huawei system.'],
