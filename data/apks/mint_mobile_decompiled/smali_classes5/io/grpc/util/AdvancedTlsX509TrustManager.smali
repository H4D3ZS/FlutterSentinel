...
# instance fields
.field public final a:Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;

.field public final b:Lio/grpc/util/AdvancedTlsX509TrustManager$SslSocketAndEnginePeerVerifier;
...
.method static constructor <clinit>()V
    ...
    .line 11
    sput-object v0, Lio/grpc/util/AdvancedTlsX509TrustManager;->d:Ljava/util/logging/Logger;
...
.method public constructor <init>(Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;Lio/grpc/util/AdvancedTlsX509TrustManager$SslSocketAndEnginePeerVerifier;)V
    .locals 1
    ...
    .line 3
    iput-object v0, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->c:Ljavax/net/ssl/X509ExtendedTrustManager;

    .line 4
    iput-object p1, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->a:Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;

    .line 5
    iput-object p2, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->b:Lio/grpc/util/AdvancedTlsX509TrustManager$SslSocketAndEnginePeerVerifier;

    return-void
.end method

.method public synthetic constructor <init>(Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;Lio/grpc/util/AdvancedTlsX509TrustManager$SslSocketAndEnginePeerVerifier;Lio/grpc/util/AdvancedTlsX509TrustManager$a;)V
    .locals 0
...
.method public static synthetic a(Lio/grpc/util/AdvancedTlsX509TrustManager;Ljava/io/File;J)J
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lio/grpc/util/AdvancedTlsX509TrustManager;->e(Ljava/io/File;J)J
...
.method public static synthetic b()Ljava/util/logging/Logger;
    ...
    .line 1
    sget-object v0, Lio/grpc/util/AdvancedTlsX509TrustManager;->d:Ljava/util/logging/Logger;
...
.method public static d(Ljava/security/KeyStore;)Ljavax/net/ssl/X509ExtendedTrustManager;
    ...
    .line 21
    .line 22
    invoke-static {v1}, Ltl;->a(Ljava/lang/Object;)Z
    ...
    .line 29
    .line 30
    invoke-static {p0}, Lul;->a(Ljava/lang/Object;)Ljavax/net/ssl/X509ExtendedTrustManager;
...
.method public final c([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;Ljava/net/Socket;Z)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->a:Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;
    ...
    .line 24
    .line 25
    iget-object v0, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->c:Ljavax/net/ssl/X509ExtendedTrustManager;
    ...
    .line 30
    .line 31
    iget-object p5, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->a:Lio/grpc/util/AdvancedTlsX509TrustManager$Verification;
    ...
    .line 48
    invoke-static {v1, p5}, Lvl;->a(Ljavax/net/ssl/SSLParameters;Ljava/lang/String;)V
    ...
    .line 53
    .line 54
    invoke-static {v0, p1, p2, p3}, Lwl;->a(Ljavax/net/ssl/X509ExtendedTrustManager;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;)V
    ...
    .line 69
    invoke-static {v2, p5}, Lvl;->a(Ljavax/net/ssl/SSLParameters;Ljava/lang/String;)V
    ...
    .line 74
    .line 75
    invoke-static {v0, p1, p2, v1}, Lxl;->a(Ljavax/net/ssl/X509ExtendedTrustManager;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/net/Socket;)V
    ...
    .line 87
    :cond_5
    invoke-static {v0, p1, p2, p3}, Lyl;->a(Ljavax/net/ssl/X509ExtendedTrustManager;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;)V
    ...
    :cond_7
    :goto_2
    iget-object p5, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->b:Lio/grpc/util/AdvancedTlsX509TrustManager$SslSocketAndEnginePeerVerifier;
...
.method public checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/net/Socket;)V
    ...
    .line 2
    invoke-virtual/range {v0 .. v5}, Lio/grpc/util/AdvancedTlsX509TrustManager;->c([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;Ljava/net/Socket;Z)V
...
.method public final e(Ljava/io/File;J)J
    .locals 3
...
.method public updateTrustCredentials([Ljava/security/cert/X509Certificate;)V
    ...
    .line 32
    :cond_0
    invoke-static {v0}, Lio/grpc/util/AdvancedTlsX509TrustManager;->d(Ljava/security/KeyStore;)Ljavax/net/ssl/X509ExtendedTrustManager;
    ...
    .line 36
    iput-object p1, p0, Lio/grpc/util/AdvancedTlsX509TrustManager;->c:Ljavax/net/ssl/X509ExtendedTrustManager;
...
.method public updateTrustCredentialsFromFile(Ljava/io/File;JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/ScheduledExecutorService;)Lio/grpc/util/AdvancedTlsX509TrustManager$Closeable;
    ...
    .line 1
    invoke-virtual {p0, p1, v0, v1}, Lio/grpc/util/AdvancedTlsX509TrustManager;->e(Ljava/io/File;J)J
